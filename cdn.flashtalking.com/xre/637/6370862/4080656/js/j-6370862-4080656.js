//Generated:2023-03-18 00:09:40// 6-273
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6370862 || '',
    guid: window.ftGUID_6370862 || '',
    confID: window.ftConfID_6370862 || '0',
    ftReturn: window.ftReturn_6370862 || '',
    keyword: window.ftKeyword_6370862 || '',
    ftId: window.ftId_6370862 || '',
    ftImpId: window.ftImp6370862 && window.ftImp6370862.impID || '',
    gdpr: window.ftImp6370862 && window.ftImp6370862.gdpr || '',
    gdpr_consent: window.ftImp6370862 && window.ftImp6370862.gdpr_consent || '',
    gdpr_pd: window.ftImp6370862 && window.ftImp6370862.gdpr_pd || '',
    us_privacy: window.ftImp6370862 && window.ftImp6370862.us_privacy || '',
    campaignID: '173409',
    cID: '116264',
    pID: '6370862',
    creativeID: '4080656',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=173409&sid=18330&plc=6370862&num=&adid=&advid=&adsrv=29&btreg=6370862&btadsrv=flashtalking&crt=4080656&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/173409;6370862;4080656;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/mena_en/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?225125093-6370862;4080656;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/637/6370862/4080656/image/4080656.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/173409;6370862;202;pixel;DV360;DV360FY20AcrobatRTRAcrobatOPMUpdatedHighReachLowAccuracyMEDSKBAN300x250/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/173409;6370862;4080656;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/mena_en/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display",
    divID: 'ftdiv6370862',
    altimgID: 'ftalt6370862',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp6370862 && parseInt(window.ftImp6370862.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m6370862') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6370862'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe6370862';
    o.file = 'http://cdn.flashtalking.com/116264/4080656/index.html';
    o.altImg = 'https://servedby.flashtalking.com/imp/8/173409;6370862;204;gif;DV360;DV360FY20AcrobatRTRAcrobatOPMUpdatedHighReachLowAccuracyMEDSKBAN300x250/?';
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_6370862;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_6370862;
